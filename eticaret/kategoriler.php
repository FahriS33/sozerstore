	...
	<div class="row">
		<div class="col-md-9">
			<div class="title-bg">
				...
				<div class="title-nav">
					<a href="javascripti:void(0);"><i class="fa fa-th-large"></i></a>
					<a href="javascripti:void(0);"><i class="fa fa-bars"></i></a>
				</div>
			</div>
			<div class="row prdct">
                     	...
                     	<div class="col-md-5">
                     		<div class="productwrap">
                     			<div class="pr-img">
                     				...
                     				<div  class="pricetag on-sale"><div class="inner on-sale"><span class="onsale"><span class="oldprice"><?php echo $uruncek['urun_fiyat']*2 ?></span><?php echo $uruncek['urun_fiyat'] ?>₺</span></div></div>
                     			</div>
